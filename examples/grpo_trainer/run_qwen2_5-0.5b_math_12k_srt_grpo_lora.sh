...
export TRAIN_FILE=examples/data_preprocess/data/math_12k/stage_1/train.parquet
export VAL_FILE=examples/data_preprocess/data/math_12k/stage_1/test.parquet
